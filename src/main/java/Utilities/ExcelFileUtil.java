...
public class ExcelFileUtil {
	...
	{
		FileInputStream fi=new FileInputStream("D:\\ERP_Stock\\ERP_Maven\\TestInput\\InputSheet.xlsx");
...
//reading Data From Cell
	...
	public void setCellData(String sheetname,int row,int column,String status)throws Throwable
	{
		...
		FileOutputStream fo=new FileOutputStream("D:\\ERP_Stock\\ERP_Maven\\TestOutput\\hybrid.xlsx");
		wb.write(fo);
		fo.close();
	}
}
