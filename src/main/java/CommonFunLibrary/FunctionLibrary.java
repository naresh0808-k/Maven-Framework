...
public class FunctionLibrary {
	...
	public static WebDriver startBrowser() throws Throwable
	{
		...
		{
			System.setProperty("webdriver.chrome.driver", "D:\\ERP_Stock\\ERP_Maven\\CommonDriver\\chromedriver.exe");
			driver=new ChromeDriver();
			
		}
		else if (PropertyFileUtil.getValueForKey("Browser").equalsIgnoreCase("firefox"))
		{
			System.setProperty("webdriver.gecko.driver", "D:\\ERP_Stock\\ERP_Maven\\CommonDriver\\chromedriver.exe");
...
// Method For Wait For Element
	...
	public static void captureData(WebDriver driver,String locatortype,String locatorvalue) throws Throwable
	{
		...
		FileWriter fw=new FileWriter("D:\\ERP_Stock\\ERP_Maven\\CaptureData\\supplier.txt");
	...
	{
		FileReader fr=new FileReader("D:\\ERP_Stock\\ERP_Maven\\CaptureData\\supplier.txt");
		BufferedReader br=new BufferedReader(fr);
		String exp_data=br.readLine();
		
		//convert colum data into intiger
		...
		driver.findElement(By.xpath(PropertyFileUtil.getValueForKey("search-panal"))).click();
			Thread.sleep(5000);
		...
		for (int i = 1; i < rows.size(); i++) 
		{
			...
			Assert.assertEquals(act_data, exp_data,"snumber is not mactching");
			break;
